...
if __name__ == '__main__':
    ...
    data_val = './crowdhuman/images/val'
    label_val = './crowdhuman/labels_with_ids/val'
    ann_val = './crowdhuman/annotation_val.odgt'
    data_train = './crowdhuman/images/train'
    label_train = './crowdhuman/labels_with_ids/train'
    ann_train = './crowdhuman/annotation_train.odgt'
