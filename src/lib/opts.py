...
class opts(object):
  def __init__(self):
    ...
    #self.parser.add_argument('--data_dir', type=str, default='/home/zyf/dataset') ##### change
    self.parser.add_argument('--data_dir', type=str, default='/Users/andreasskibyandersen/Documents/Github/FairMOT') #####
